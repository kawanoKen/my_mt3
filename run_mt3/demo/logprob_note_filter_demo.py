...
def main() -> None:
    ap = argparse.ArgumentParser(description="Demo: infer -> logprob note filter -> debug piano roll")
    ap.add_argument(
        "--ckpt",
        type=str,
    ...
    ap.add_argument("--out_dir", type=str, default="outputs/demo/logprob_note_filter")
    ...
    ap.add_argument("--pseudo_note_prob_threshold", type=float, default=-1.0)
