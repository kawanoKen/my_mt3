...
# Usage:
#   bash run_mt3/run_maps_ssl_pretrain10000_200e_eval_all.sh
#   NPROC=1 BS=2 bash run_mt3/run_maps_ssl_pretrain10000_200e_eval_all.sh
#
# This script does all steps in one run:
#   1) Train SSL from pretrained model_ep10000 for 200 epochs
...
PRETRAINED_CKPT="${PRETRAINED_CKPT:-checkpoints_MAPS/run_maps_supervised_10000ep/model_ep10000.pt}"
...
SAVE_DIR="${SAVE_DIR:-checkpoints_MAPS/run_maps_maestro_ssl_from_pretrain_ep10000_200e}"
PSEUDO_DEBUG_DIR="${PSEUDO_DEBUG_DIR:-outputs/pseudo_debug/run_maps_maestro_ssl_from_pretrain_ep10000_200e}"
EVAL_ROOT="${EVAL_ROOT:-outputs/maps_eval_run_maps_maestro_ssl_from_pretrain_ep10000_200e}"
